...
def get_project_by_title(title):
    ...
    print(f"Project information is:\n Title: {row[1]}\nID: {row[0]}\nDescription: {row[2]}\nMax Grade: {row[3]}")
...
def get_grade_by_github_title(github, title):
    ...
    print(f"Name of the student's github {row[0]}, title is {row[1]} and grade is {row[2]}")
...
def assign_grade(github, title, grade):
    ...
    print(f"Successfully added graded assignment: {title} with a grade of {grade}, for {github}!")
